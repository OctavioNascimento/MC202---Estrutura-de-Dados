 ...
 **/
int **calcularAltitudes(int m, int n, int seed); //ok

/**
 * Cria um novo mundo representado por uma matriz
 * de blocos alocada dinamicamente.
 **/
Bloco ***criarMundo(int m, int n, int **altitudes, int seed); //ok
...
double explorarMundo(
    ...
    int *qtdDiamante, int *qtdOuro, int *qtdFerro, int *qtdBlocos); //ok
